...
unatienda_integration:
  ...
  - feature: "Yappy API Integration"
    ...
    status_history:
      - working: false
        agent: "main"
        comment: "⚠️ Yappy validate/merchant returns 400 Bad Request. This is likely because the domain URL (https://chipi-link-app.preview.emergentagent.com) needs to be registered in the Yappy Comercial dashboard. The integration code is correct but requires domain registration to work."
      - working: true
        agent: "testing"

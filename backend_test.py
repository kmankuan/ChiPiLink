...
class ChiPiLinkMicroservicesAPITester:
    def __init__(self, base_url="https://monday-widget-fix.preview.emergentagent.com"):
        ...
        if admin_config:
            ...
            updated_config = {
                ...
                "yappy": {
                    ...
                    "url_domain": "https://monday-widget-fix.preview.emergentagent.com",
                    "activo": True,
                    "ambiente": "produccion"
                }
            }
    ...
    def test_yappy_checkout_flow_simple(self):
        ...
        ipn_params = {
            ...
            "domain": "https://monday-widget-fix.preview.emergentagent.com"
        }

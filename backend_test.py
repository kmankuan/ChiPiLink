...
class ChiPiLinkMicroservicesAPITester:
    def __init__(self, base_url="https://student-cleanup-tool.preview.emergentagent.com"):
        ...
        if admin_config:
            ...
            updated_config = {
                ...
                "yappy": {
                    ...
                    "url_domain": "https://student-cleanup-tool.preview.emergentagent.com",
                    "activo": True,
                    "ambiente": "produccion"
                }
            }
    ...
    def test_yappy_checkout_flow_simple(self):
        ...
        ipn_params = {
            ...
            "domain": "https://student-cleanup-tool.preview.emergentagent.com"
        }

...
class ChiPiLinkMicroservicesAPITester:
    def __init__(self, base_url="https://pushnotify-2.preview.emergentagent.com"):
        ...
        if admin_config:
            ...
            updated_config = {
                ...
                "yappy": {
                    ...
                    "url_domain": "https://pushnotify-2.preview.emergentagent.com",
                    "activo": True,
                    "ambiente": "produccion"
                }
            }
    ...
    def test_yappy_checkout_flow_simple(self):
        ...
        ipn_params = {
            ...
            "domain": "https://pushnotify-2.preview.emergentagent.com"
        }

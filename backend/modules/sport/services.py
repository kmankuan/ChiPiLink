...
async def create_live_session(data: dict) -> dict:
    ...
    session = {
        ...
        "status": "live",
        "player_a": {"player_id": pa["player_id"], "nickname": pa["nickname"], "elo": pa["elo"], "photo_url": pa.get("avatar_url", "")},
        "player_b": {"player_id": pb["player_id"], "nickname": pb["nickname"], "elo": pb["elo"], "photo_url": pb.get("avatar_url", "")},
        "referee": {"player_id": ref["player_id"], "nickname": ref["nickname"], "photo_url": ref.get("avatar_url", "")},
        "league_id": data.get("league_id"),

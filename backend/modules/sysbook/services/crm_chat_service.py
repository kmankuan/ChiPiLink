"""
CRM Chat Service (Sysbook Module)
...
from modules.store.integrations.monday_crm_adapter import crm_monday_adapter
...
class CrmChatService:
    ...
    async def link_student_on_order_submit(
        ...
        try:
            ...
            if not item_id:
                logger.warning(f"Could not link student {student_id} to CRM")
                return result
    ...
    async def get_admin_inbox(self) -> Dict:
        """Get all CRM chat conversations for admin view"""

...
async def seed_default_dictionary(db) -> list:
    ...
    defaults = [
        ...
        # Dropdown option values (common choices)
        {"en": "Cash", "es": "Efectivo", "zh": "现金", "category": "options"},
        {"en": "Bank Transfer", "es": "Transferencia Bancaria", "zh": "银行转账", "category": "options"},
        {"en": "Credit Card", "es": "Tarjeta de Crédito", "zh": "信用卡", "category": "options"},
        {"en": "Debit Card", "es": "Tarjeta de Débito", "zh": "借记卡", "category": "options"},
        {"en": "Check", "es": "Cheque", "zh": "支票", "category": "options"},
        {"en": "Male", "es": "Masculino", "zh": "男", "category": "options"},
        {"en": "Female", "es": "Femenino", "zh": "女", "category": "options"},
        {"en": "Yes", "es": "Sí", "zh": "是", "category": "options"},
        {"en": "No", "es": "No", "zh": "否", "category": "options"},
        {"en": "Active", "es": "Activo", "zh": "有效", "category": "options"},
        {"en": "Inactive", "es": "Inactivo", "zh": "无效", "category": "options"},
        {"en": "Pending", "es": "Pendiente", "zh": "待处理", "category": "options"},
        {"en": "Approved", "es": "Aprobado", "zh": "已批准", "category": "options"},
        {"en": "Rejected", "es": "Rechazado", "zh": "已拒绝", "category": "options"},
        {"en": "Completed", "es": "Completado", "zh": "已完成", "category": "options"},
        {"en": "Cancelled", "es": "Cancelado", "zh": "已取消", "category": "options"},
        {"en": "Processing", "es": "En Proceso", "zh": "处理中", "category": "options"},
        {"en": "Shipped", "es": "Enviado", "zh": "已发货", "category": "options"},
        {"en": "Delivered", "es": "Entregado", "zh": "已交付", "category": "options"},
        {"en": "Father", "es": "Padre", "zh": "父亲", "category": "options"},
        {"en": "Mother", "es": "Madre", "zh": "母亲", "category": "options"},
        {"en": "Sibling", "es": "Hermano/a", "zh": "兄弟姐妹", "category": "options"},
        {"en": "Spouse", "es": "Cónyuge", "zh": "配偶", "category": "options"},
        {"en": "Friend", "es": "Amigo/a", "zh": "朋友", "category": "options"},
        {"en": "New", "es": "Nuevo", "zh": "新", "category": "options"},
        {"en": "Used", "es": "Usado", "zh": "二手", "category": "options"},
        {"en": "Small", "es": "Pequeño", "zh": "小", "category": "options"},
        {"en": "Medium", "es": "Mediano", "zh": "中", "category": "options"},
        {"en": "Large", "es": "Grande", "zh": "大", "category": "options"},
        {"en": "High", "es": "Alto", "zh": "高", "category": "options"},
        {"en": "Low", "es": "Bajo", "zh": "低", "category": "options"},
        {"en": "None", "es": "Ninguno", "zh": "无", "category": "options"},
    ]

...
# Commerce Engine Proxy (store + sysbook + platform-store on port 8005)
...
# Platform Store - now proxied through Commerce Engine
...
# init_platform_store_routes — now in Commerce Engine
...
# Initialize Store module — now in Commerce Engine
# init_store()
...
api_router.include_router(store_proxy_router)     # Commerce Engine proxy
api_router.include_router(sysbook_proxy_router)    # Commerce Engine proxy
...
api_router.include_router(platform_store_proxy_router)  # Commerce Engine proxy
...
async def startup_event():
    ...
    async def _deferred_init():
        ...
        # Bootstrap Commerce Engine (port 8005)
        try:
            import subprocess

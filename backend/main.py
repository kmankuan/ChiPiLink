...
# ============== IMPORT CORE ==============
from core.database import db, client, close_database, create_indexes, seed_admin_user, seed_site_config, seed_translations
...
async def startup_event():
    ...
    # Seed essential data (admin user, site config)

...
def test_main_app_health():
    ...
    try:
        response = requests.get("https://deployment-blocker-11.preview.emergentagent.com/api/health", timeout=10)
...
def test_admin_login():
    ...
    try:
        response = requests.post(
            "https://deployment-blocker-11.preview.emergentagent.com/api/auth-v2/login",

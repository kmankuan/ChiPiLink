...
def test_main_app_health():
    ...
    try:
        response = requests.get("https://tutor-engine-ui.preview.emergentagent.com/api/health", timeout=10)
...
def test_admin_login():
    ...
    try:
        response = requests.post(
            "https://tutor-engine-ui.preview.emergentagent.com/api/auth-v2/login",

...
// Animation preview for status manager — delegates to shared StatusAnimation with admin-sized scale
function StatusAnimationPreview({ animation, color, gifUrl }) {
  return <StatusAnimation type={animation} color={color} gifUrl={gifUrl} scale={1.3} />;
}
...
export default function LayoutPreviewModule() {
  ...
  return (
    <div className="space-y-6" data-testid="layout-preview-module">
      {/* Keyframes injected globally by StatusAnimation */}
      {/* Header */}
      <div>
